...
public class JsonConfiguration extends FileConfiguration {
     ...
     *   for List: calls {@link #buildList(List)} which functions similar to this method.
     ...
     *
     * Functions similarly to {@link #dealWithSerializedObjects(Map)} but only for detecting lists within
